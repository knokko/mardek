...
public class Vk2dPipelines {
	...
	public final Vk2dKimPipeline kim1, kim2, kim3;
	...
	public Vk2dPipelines(Vk2dInstance instance, Vk2dPipelineContext context, Vk2dConfig config) {
		...
		this.kim2 = config.kim1 ? new Vk2dKimPipeline(context, instance, 2) : null;
		this.kim3 = config.kim1 ? new Vk2dKimPipeline(context, instance, 3) : null;
		this.text = config.text ? new Vk2dGlyphPipeline(context, instance) : null;
	}

	public void destroy() {
		Vk2dPipeline[] all = { color, oval, image, kim1, kim2, kim3, text };
