...
class CharacterState {
	...
	/**
	 * The amount of experience points that this character has gained since reaching [currentLevel].
	 * When this reaches (or exceeds) [experienceForNextLevel], the character gets a level-up, and this variable is
	 * decreased by the old result of `experienceForNextLevel()`.
	 */
	@BitField(id = 3)
	@IntegerField(expectUniform = false, minValue = 0)
