...
class BattleEnemySelection(
	...
	override fun toString() = "EnemySelection(layout=$enemyLayout, enemies=$enemyNames)"

	override fun equals(other: Any?) = other is BattleEnemySelection && enemyLayout == other.enemyLayout &&
			enemyNames == other.enemyNames

	override fun hashCode() = enemyLayout.hashCode() + 31 * enemyNames.hashCode()
}
...
class SharedEnemySelections(
	...
	@Suppress("unused")
	private constructor() : this("", ArrayList(0))
