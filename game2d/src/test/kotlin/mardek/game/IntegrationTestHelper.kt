...
fun TestingInstance.testRendering(
	...
	if (state is InGameState) {
		val context = RenderContext(
			frame, mainStage, framebuffers, perFrameResources, pipelines,
			fancyTextPipeline, areaSpritePipeline, areaLightPipeline, animationPartPipeline,
			textBuffer, perFrameDescriptorSet,
			recorder, content, stateManager,
		)
	}
