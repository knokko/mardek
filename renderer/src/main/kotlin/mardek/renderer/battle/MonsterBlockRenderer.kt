...
class MonsterBlockRenderer(
	...
	private fun shouldRender() = enemy.isAlive()
	...
	fun render() {
		...
		run {
			...
			healthBar.renderBar(enemy.currentHealth, enemy.maxHealth)
